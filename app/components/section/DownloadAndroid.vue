<template>
  <section id="download-android" class="w-full bg-gray-100 rounded-lg shadow px-6 py-4 min-h-[100px]">
    <img src="/images/icons/android-robot.png" alt="Android" class="h-14">
    <h2 class="leading-6 text-xl pt-8 pb-4 font-black">
      {{ t("Index.Downloads.Sections.Android.Header") }}
    </h2>
    ...
    <section class="flex justify-between mt-6">
      <div class="flex-grow">
        <div>
          <div class="flex items-center relative">
            <img
              src="/images/icons/services/google-play.svg" width="39" alt="Google Play logo"
              class="relative z-10"
            >
            <NuxtLink
              :href="runtimeConfig.public.app.googleplay"
        ...
        <div class="mt-2">
          <div class="flex items-center relative">
            <img
              src="/images/icons/services/fdroid.png" width="43" alt="F-Droid logo"
              class="relative z-10"
            >
            <NuxtLink
              :href="runtimeConfig.public.app.fdroid"
        ...
        <p class="mt-4">
          ...
          <NuxtLink
            :href="asset_universal?.browser_download_url"
            class="underline underline-offset-4 hover:text-blue-600 transition-colors"
          >
            universal
          </NuxtLink> /
          <NuxtLink
            :href="asset_arm64_v8a?.browser_download_url"
            class="underline underline-offset-4 hover:text-blue-600 transition-colors"
          >
            arm64-v8a
          </NuxtLink> /
          <NuxtLink
            :href="asset_armeabi_v7a?.browser_download_url"
            class="underline underline-offset-4 hover:text-blue-600 transition-colors"
          >
            armeabi-v7a
          </NuxtLink> /
          <NuxtLink
            :href="asset_x86_64?.browser_download_url"
            class="underline underline-offset-4 hover:text-blue-600 transition-colors"
          >
            x86_64
          </NuxtLink>
      ...
      <img
        src="/images/qr/google-play.svg" alt="AltStore QR" width="128"
