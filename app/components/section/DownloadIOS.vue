<template>
  <section id="download-ios" class="w-full bg-gray-100 rounded-lg shadow px-6 py-4 min-h-[100px]">
    <img src="/images/icons/apple.png" alt="iOS" class="h-14">
    <h2 class="leading-6 text-xl pt-8 pb-4 font-black">
      {{ t("Index.Downloads.Sections.iOS.Header") }}
    </h2>
    ...
    <section class="flex justify-between mt-6">
      ...
      <img
        src="/images/qr/altstore-source.svg" alt="AltStore QR" width="128"
